...
tsyringe_1.container.register(tokens_1.ServiceTokens.AppConfig, {
    useValue: appConfig,
});
tsyringe_1.container.register(tokens_1.ServiceTokens.HelloService, {
...
tsyringe_1.container.register(tokens_1.ServiceTokens.GreetingRepository, {
    useValue: greetingRepository,
});
tsyringe_1.container.register(tokens_1.ServiceTokens.GreetingService, {
