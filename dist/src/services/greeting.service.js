...
const getGreetingMessageUsecase_1 = require("../usecases/getGreetingMessageUsecase");
let GreetingService = class GreetingService {
    constructor(greetingRepository, appConfig, eventPublisher) {
        this.greetingRepository = greetingRepository;
        this.appConfig = appConfig;
        this.eventPublisher = eventPublisher;
    }
    async buildMessage(input) {
        const message = (0, getGreetingMessageUsecase_1.getGreetingMessage)(input.name, this.appConfig.greetingStyle);
...
exports.GreetingService = GreetingService = __decorate([
    ...
    __param(2, (0, tsyringe_2.inject)(injection_tokens_1.ServiceTokens.EventPublisher)),
